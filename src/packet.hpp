...
constexpr std::uint8_t IPPROTO_UDP_NUM = 17;
...
public:
    ...
    UdpHdr*   udp() { return udp_ ? reinterpret_cast<UdpHdr*>(bytes.data() + l4_off_) : nullptr; }
    ...
    const UdpHdr* udp() const { return udp_ ? reinterpret_cast<const UdpHdr*>(bytes.data() + l4_off_) : nullptr; }
    ...
    std::size_t l4_hdr_len() const { return payload_off_ - l4_off_; }
    std::size_t l4_off() const { return l4_off_; }
