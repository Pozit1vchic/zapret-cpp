...
const std::vector<Service>& services() {
    static const std::vector<Service> table = {
        ...
        {"anthropic",    {"anthropic.com", "claude.ai", "claude.com"},          Strategy::FakeMultidisorder, -1, 3, true},
        ...
        {"copilot",      {"copilot.microsoft.com", "bing.com", "bingapis.com",
                          "copilot.Microsoft.com", "microsoft365.com"},         Strategy::FakeMultidisorder, -1, 3, true},
        {"groq",         {"groq.com", "console.groq.com"},                      Strategy::FakeMultidisorder, -1, 3, true},
        {"perplexity",   {"perplexity.ai", "pplx.ai"},                          Strategy::FakeMultidisorder, -1, 3, true},
        {"xai",          {"x.ai", "grok.com", "api.x.ai"},                      Strategy::FakeMultidisorder, -1, 3, true},
        {"mistral",      {"mistral.ai", "mistral.com"},                         Strategy::FakeMultidisorder, -1, 3, true},
        {"huggingface",  {"huggingface.co", "hf.co"},                           Strategy::FakeMultidisorder, -1, 3, true},
        {"cohere",       {"cohere.ai", "cohere.com"},                           Strategy::FakeMultidisorder, -1, 3, true},
        {"deepseek",     {"deepseek.com", "deepseek.ai"},                       Strategy::FakeMultidisorder, -1, 3, true},
